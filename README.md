...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ea6qr50.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ea6qr50.containers.anotherwebservice.com/
...
```
git clone git@github.com:jimbriam/container-ea6qr50.git
cd container-ea6qr50
```
...
```
docker attach container-ea6qr50
```
